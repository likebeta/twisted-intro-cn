...
<div style="text-align: center"><img src="_static/p16_application.png" title="fastpoetry 应用的结构图" alt="fastpoetry 应用的结构图" /></div>
<div style="text-align: center">图34 fastpoetry 应用的结构图</div>
