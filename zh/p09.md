...
因此，我们为诗歌下载客户端添加了一个假想的功能。设想一些计算机科学家发明了一种新诗歌关联算法，Byronification引擎。这个漂亮的算法根据一首诗歌生成一首使用[Lord Byron](http://en.wikipedia.org/wiki/George_Gordon_Byron,_6th_Baron_Byron)式的同样的诗歌。另外，专家们提供了其Python的接口，即：
```python
...
<center>![可能的deferred激活路线](_static/p09_deferred-2.png)</center>
